...
//SQL文
$query = "SELECT show_date, show_name, song_name FROM wp_setlist WHERE mem1_eq1 = '".$label."' OR mem1_eq2 = '".$label."' OR mem1_eq3 = '".$label."' OR mem2_eq1 = '".$label."' OR mem2_eq2 = '".$label."' OR mem2_eq3 = '".$label."' OR mem3_eq1 = '".$label."' OR mem3_eq2 = '".$label."' OR mem3_eq3 = '".$label."' OR mem4_eq1 = '".$label."' OR mem4_eq2 = '".$label."' OR mem4_eq3 = '".$label."' OR mem4_eq3 = '".$label."' OR mem5_eq1 = '".$label."' OR mem5_eq2 = '".$label."' OR mem5_eq3 = '".$label."' OR mem6_eq1 = '".$label."' OR mem6_eq2 = '".$label."' OR mem6_eq3 = '".$label."'";
//SQLクエリを連想配列で取得
