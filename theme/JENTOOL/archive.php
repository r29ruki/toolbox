...
<?php if( in_category( array('16','3','4','5') ) ) : ?>
<h2>EQUIPMENT</h2>
<?php else: ?>
...
<!-- カテゴリーアーカイブの場合 *2 -->
       <?php /* If this is a category archive */ if( in_category(array('16','3','4','5'))) { ?>
<!-- カテゴリー名を表示 -->
...
<?php elseif( in_category( array('18','19','20','21','22','23','24','106') ) ) : ?>
<!-- 投稿データを取得するループ *3 -->
...
<?php elseif( in_category( array('17') ) ) : ?>
<!-- 投稿データを取得するループ *3 -->
<!-- 記事名だけリスト表示 -->
<div class="post">
<ul class="list_A">
